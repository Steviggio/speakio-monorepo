...
export default function PreferencesSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-[var(--color-text)]">{t('settings.preferencesTitle')}</h1>
        <p className="text-sm text-[var(--color-text-secondary)] mt-1">{t('settings.preferencesDesc')}</p>
      </div>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-[var(--color-text)] mb-1.5">{t('settings.interfaceLanguage')}</label>
            <select
              value={interfaceLang}
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">{t('settings.interfaceLanguageDesc')}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-[var(--color-text)] mb-1.5">{t('settings.resourcesPerPage')}</label>
            <select
      ...
      <Card className="p-6">
        ...
        <div className="flex items-center justify-between py-2">
          <div>
            <p className="text-sm font-medium text-[var(--color-text)]">{t('settings.emailNotifications')}</p>
            <p className="text-xs text-[var(--color-text-muted)]">{t('settings.emailNotificationsDesc')}</p>
          </div>
          <button
          ...
          >
            <span className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${emailNotifications ? 'translate-x-4' : 'translate-x-0'}`} />
          </button>
        </div>
      </Card>
