...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    setPage(1);
  }, [debouncedSearch, typeFilter, pricingFilter, languageFilter]);
  ...
  const selectClasses =
    "h-10 rounded-lg border border-[var(--color-border)] bg-white px-3 text-sm text-[var(--color-text-secondary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-brand)]/30 appearance-none";
