...
const ResourceSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: ['BOOK', 'AUDIO', 'VIDEO', 'APP', 'CHAT', 'ARTICLE', 'WEBSITE'],
    },
    language: String,
    tags: [String],
    pricing: {
...
async function seed() {
  ...
  if (existingResources === 0) {
    const resources = [
      {
        title: 'Duolingo',
        description:
          'Gamified language learning app with bite-sized lessons and streaks.',
        url: 'https://duolingo.com',
        type: 'APP',
        language: 'multi',
        tags: ['gamification', 'beginner'],
        pricing: 'FREEMIUM',
      },
      {
        title: 'Anki',
        description:
          'Powerful spaced repetition flashcard system for vocabulary retention.',
        url: 'https://apps.ankiweb.net',
        type: 'APP',
        language: 'multi',
        tags: ['flashcards', 'srs', 'vocabulary'],
        pricing: 'FREE',
      },
      {
        title: 'Pimsleur',
        description:
          'Audio-based language learning method focusing on conversation skills.',
        url: 'https://pimsleur.com',
        type: 'AUDIO',
        language: 'multi',
        tags: ['audio', 'conversation', 'premium'],
        pricing: 'PREMIUM',
      },
      {
        title: 'Assimil',
        description:
          'Classic French method for intuitive language learning through parallel texts.',
        url: 'https://assimil.com',
        type: 'BOOK',
        language: 'fr',
        tags: ['book', 'immersion', 'method'],
        pricing: 'PREMIUM',
      },
      {
        title: 'Easy French (YouTube)',
        description:
          'Street interviews in French with subtitles for authentic listening practice.',
        url: 'https://youtube.com/c/EasyFrench',
        type: 'VIDEO',
        language: 'fr',
        tags: ['youtube', 'listening', 'authentic'],
        pricing: 'FREE',
      },
      {
        title: 'SpanishPod101',
        description:
          'Comprehensive Spanish podcast lessons from beginner to advanced.',
        url: 'https://spanishpod101.com',
        type: 'AUDIO',
        language: 'es',
        tags: ['podcast', 'lessons'],
        pricing: 'FREEMIUM',
      },
      {
        title: 'Lingoda',
        description:
          'Online language school with live classes and certified teachers.',
        url: 'https://lingoda.com',
        type: 'WEBSITE',
        language: 'multi',
        tags: ['live-classes', 'certified'],
        pricing: 'PREMIUM',
      },
      {
        title: 'Tandem',
        description:
          'Language exchange app to practice speaking with native speakers worldwide.',
        url: 'https://tandem.net',
        type: 'CHAT',
        language: 'multi',
        tags: ['exchange', 'speaking', 'community'],
        pricing: 'FREE',
      },
      {
        title: 'Fluent Forever',
        description:
          'Method and app based on pronunciation-first learning and memory science.',
        url: 'https://fluent-forever.com',
        type: 'APP',
        language: 'multi',
        tags: ['pronunciation', 'method', 'memory'],
        pricing: 'PREMIUM',
      },
      {
        title: 'News in Slow Spanish',
        description:
          'Weekly news in slow, clear Spanish for intermediate learners.',
        url: 'https://newsinslowspanish.com',
        type: 'AUDIO',
        language: 'es',
        tags: ['news', 'intermediate', 'listening'],
        pricing: 'FREEMIUM',
      },
      {
        title: 'Deutsche Welle Learn German',
        description:
          'Free comprehensive German courses from A1 to C level by Deutsche Welle.',
        url: 'https://dw.com/en/learn-german',
        type: 'WEBSITE',
        language: 'de',
        tags: ['course', 'free', 'german'],
        pricing: 'FREE',
      },
      {
        title: 'Italki',
        description:
          'Platform connecting students with professional language tutors for 1-on-1 lessons.',
        url: 'https://italki.com',
        type: 'WEBSITE',
        language: 'multi',
        tags: ['tutor', 'one-on-one', 'professional'],
        pricing: 'FREEMIUM',
      },
    ];
    ...
    await Resource.insertMany(
      resources.map((r) => ({
        ...
        positiveVotes: Math.floor(Math.random() * 50) + 5,
        negativeVotes: Math.floor(Math.random() * 5),
      })),
    );
  ...
  if (existingPosts === 0) {
    ...
    await Post.insertMany(posts.map((p) => ({ ...p, author: seedUser._id })));
